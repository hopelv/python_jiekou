...
def send_email_by_qq(to):
    sender_mail = '512044050@qq.com'
    sender_pass = 'xofoxzeqmyjzcagc'#同样是乱打的

    # 设置总的邮件体对象，对象类型为mixed
    msg_root = MIMEMultipart('mixed')
    # 邮件添加的头尾信息等
    msg_root['From'] = '512044050@qq.com'
    msg_root['To'] = to
    # 邮件的主题，显示在接收邮件的预览页面
    ...
    # 构造图片
    image_file = open(r'D:\PROJECT\picture\AL电厂经营战略分析.png', 'rb').read()
    ...
    # 构造附件
    txt_file = open(r'D:\PROJECT\lunwen\AL电厂经营战略分析.txt', 'rb').read()
...
if __name__ == '__main__':
    ...
    to = '1049252083@qq.com,ex-lvjunbo@fcsc.com'
    send_email_by_qq(to)
